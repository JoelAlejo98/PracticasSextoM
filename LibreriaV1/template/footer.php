<!-- Footer -->
  ...
  <!-- Page level plugins -->
  <script src="resources/paginaMaestra/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="resources/paginaMaestra/js/demo/chart-area-demo.js"></script>
  <script src="resources/paginaMaestra/js/demo/chart-pie-demo.js"></script>
